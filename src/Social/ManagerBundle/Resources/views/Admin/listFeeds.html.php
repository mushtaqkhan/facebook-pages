...
$view['slots']->set('title', $view['translator']->trans("List Feeds"));
?>
<div class="col-md-9">
    <div class="panel panel-blue">
        <div class="panel-heading">
            <h2 class="panel-title"><i class="fa fa-archive"></i> <?php echo $view['translator']->trans("List Feeds"); ?></h2>
        </div>
                ...
                <tbody>
                    <?php if ($list) { ?>
                        ...
                        foreach ($list as $value) {
                            $url = $view['router']->generate('_admin_del_feed', array('id' => $value->getId()), true);
                            $urlView = "";
                            if ($value->getFeedId()) {
    ...
    <div class="col-lg-12">
        <div class="row">
            <?php
            if ($page["NextPage"] > 1) {
                $urlNext = $view['router']->generate('_admin_feed', array(), true);
                ?>
                <ul class="pagination">
