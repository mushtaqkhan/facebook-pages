...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'social_manager_locale.locale_listener' => 'getSocialManagerLocale_LocaleListenerService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('social_manager_locale.locale_listener', 'Social\\ManagerBundle\\EventListener\\LocaleListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'facebook', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Social/ManagerBundle/Resources/config/doctrine') => 'Social\\ManagerBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Social\\ManagerBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('SocialManagerBundle' => 'Social\\ManagerBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c5facf9add29d4542cd17281b22a525f0b904db68eecf68b0fe3e8ab064957e7');
    ...
    /**
     * Gets the 'social_manager_locale.locale_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Social\ManagerBundle\EventListener\LocaleListener A Social\ManagerBundle\EventListener\LocaleListener instance.
     */
    protected function getSocialManagerLocale_LocaleListenerService()
    {
        return $this->services['social_manager_locale.locale_listener'] = new \Social\ManagerBundle\EventListener\LocaleListener('en');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Social/ManagerBundle/Resources/views'), 'SocialManager');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('80a104c20f26d2a6172513f929059b9009db2be8');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SocialManagerBundle' => 'Social\\ManagerBundle\\SocialManagerBundle',
            ...
            'locale' => 'en',
            'secret' => '80a104c20f26d2a6172513f929059b9009db2be8',
            'limit' => 12,
            'page' => 10,
            ...
            'kernel.secret' => '80a104c20f26d2a6172513f929059b9009db2be8',
